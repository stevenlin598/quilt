...
func (_m *EC2Client) RunInstances(_a0 *ec2.RunInstancesInput) (*ec2.Reservation, error) {
	ret := _m.Called(_a0)
...
func (_m *EC2Client) WaitUntilInstanceExists(_a0 *ec2.DescribeInstancesInput) error {
	ret := _m.Called(_a0)
...
func (_m *EC2Client) WaitUntilInstanceTerminated(_a0 *ec2.DescribeInstancesInput) error {
	ret := _m.Called(_a0)
...
func (_m *EC2Client) WaitUntilSpotInstanceRequestFulfilled(_a0 *ec2.DescribeSpotInstanceRequestsInput) error {
	ret := _m.Called(_a0)
